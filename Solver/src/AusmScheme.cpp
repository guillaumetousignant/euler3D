...
void AusmScheme::computeFluxDiss(Block* block)
{
	...
	double rho_L,u_L,v_L,w_L,p_L,H_L,qq_L,V_L,c_L,rho_R,u_R,v_R,w_R,p_R,H_R,qq_R,V_R,c_R,M_L_R;
	...
	for (int face_idx = 0; face_idx < nface; face_idx++)
	{
		...
		flux_2_convective = 0.5*M_L_R*(Fc_L_2+Fc_R_2)*normal_norm;
		flux_3_convective = 0.5*M_L_R*(Fc_L_3+Fc_R_3)*normal_norm;
		flux_4_convective = 0.5*M_L_R*(Fc_L_4+Fc_R_4)*normal_norm;
	...
	double M_L,M_R,p_L_plus,p_R_minus;
