...
class Solver():
    def __init__(self, master):
        ...
        title_section_2_1.grid_columnconfigure(0, weight=1)
        title_section_2_1.grid_columnconfigure(3, weight=1)
        title_section_2_1.grid_rowconfigure(0, weight=1)
        title_section_2_1.grid_rowconfigure(4, weight=1)

        ttk.Label(title_section_2_1, text=" ").grid(row=0, column=0, columnspan=4, sticky=NSEW)

        text_section_2_1 = ttk.Label(title_section_2_1, text="\nPlease specify the required convergence criteria:\n")
        text_section_2_1.grid(row=1, column=0, columnspan=4, sticky=NSEW, padx=2)

        ttk.Label(title_section_2_1, text=" ").grid(row=2, column=0, sticky=NSEW)
        ...
        self.max_iter_label.grid(row=2, column=1, sticky=NSEW, padx=2, pady=2)
        self.max_iter_entry = ttk.Entry(title_section_2_1, textvariable=self.max_iter, width=15, justify=CENTER, takefocus=0)
        self.max_iter_entry.grid(row=2, column=2, sticky=NSEW, padx=2, pady=2)

        ttk.Label(title_section_2_1, text=" ").grid(row=2, column=3, sticky=NSEW)
        ...
        self.convergence_crit_label.grid(row=3, column=1, sticky=NSEW, padx=2, pady=2)
        ...
        self.convergence_crit_entry.grid(row=3, column=2, sticky=NSEW, padx=2, pady=2)

        ttk.Label(title_section_2_1, text=" ").grid(row=4, column=0, columnspan=4, sticky=NSEW)
        ...
        title_section_2_2.grid_columnconfigure(0, weight=1)
        title_section_2_2.grid_columnconfigure(2, weight=1)
        title_section_2_2.grid_rowconfigure(0, weight=1)
        title_section_2_2.grid_rowconfigure(3, weight=1)

        ttk.Label(title_section_2_2, text=" ").grid(row=0, column=0, columnspan=3, sticky=NSEW)

        text_section_2_2 = ttk.Label(title_section_2_2, text="\nPlease select the required flux scheme:\n")
        text_section_2_2.grid(row=1, column=0, columnspan=3, sticky=NSEW, padx=2)

        ttk.Label(title_section_2_2, text=" ").grid(row=2, column=0, sticky=NSEW)
        ...
        flux_scheme_button.grid(row=2, column=1, sticky=NSEW)

        ttk.Label(title_section_2_2, text=" ").grid(row=2, column=2, sticky=NSEW)

        ttk.Label(title_section_2_2, text=" ").grid(row=3, column=0, columnspan=3, sticky=NSEW)
        ...
        title_section_2_3.grid_columnconfigure(0, weight=1)
        title_section_2_3.grid_columnconfigure(5, weight=1)
        title_section_2_3.grid_rowconfigure(0, weight=1)
        title_section_2_3.grid_rowconfigure(6, weight=1)

        ttk.Label(title_section_2_3, text=" ").grid(row=0, column=0, columnspan=6, sticky=NSEW)

        text_section_2_3 = ttk.Label(title_section_2_3, text="\nPlease select a code option:\n")
        text_section_2_3.grid(row=1, column=0, columnspan=6, sticky=NSEW, padx=2)
        
        Label(title_section_2_3, text=" ").grid(row=2, column=0, sticky=NSEW)
        ...
        self.nb_process_label.grid(row=2, column=1, columnspan=2, sticky=NSEW, padx=2, pady=2)
        self.nb_process_entry = ttk.Entry(title_section_2_3, textvariable=self.nb_process, width=15, justify=CENTER, takefocus=0)
        self.nb_process_entry.grid(row=2, column=3, columnspan=2, padx=2, pady=2)

        ttk.Label(title_section_2_3, text=" ").grid(row=1, column=5, sticky=NSEW)
        ...
        self.solver_option_build.grid(row=3, column=1, columnspan=4, padx=2, pady=2)
        ...
        self.solver_option_execute.grid(row=4, column=1, columnspan=4, padx=2, pady=2)
        ...
        self.solver_option_build_execute.grid(row=5, column=1, columnspan=4, padx=2, pady=2)

        ttk.Label(title_section_2_3, text=" ").grid(row=6, column=0, columnspan=6, sticky=NSEW)
