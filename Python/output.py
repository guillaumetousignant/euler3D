...
class Output():
    def __init__(self, master):
        ...
        files_type_euler = Radiobutton(title_section_3_1, text=" Légend'air", value=0, variable=self.files_type_, relief="groove", width=20, borderwidth=2, anchor=W, takefocus=0)
