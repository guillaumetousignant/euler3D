...
class Output():
    def __init__(self, master):
        ...
        self.cl_alpha.set(0)
        cl_alpha_button = Checkbutton(title_section_3_2, text="Cl vs alpha", variable=self.cl_alpha, relief="groove", width=20, anchor=W, borderwidth=2)
        cl_alpha_button.grid(row=1, column=0, columnspan=2, padx=2, pady=2)
            
        self.cd_alpha = IntVar()
        self.cd_alpha.set(0)
        cd_alpha_button = Checkbutton(title_section_3_2, text="Cd vs alpha", variable=self.cd_alpha, relief="groove", width=20, anchor=W, borderwidth=2)
        cd_alpha_button.grid(row=2, column=0, columnspan=2, padx=2, pady=2)

        self.cm_alpha = IntVar()
        self.cm_alpha.set(0)
        cm_alpha_button = Checkbutton(title_section_3_2, text="Cm vs alpha", variable=self.cm_alpha, relief="groove", width=20, anchor=W, borderwidth=2)
        ...
        coefficients_convergence_button = Checkbutton(title_section_3_2, text="Cl, cd, cm convergence", variable=self.coefficients_convergence, relief="groove", width=20, anchor=W, borderwidth=2)
        coefficients_convergence_button.grid(row=4, column=0, columnspan=2, padx=2, pady=2)

        self.cp_xc = IntVar()
        self.cp_xc.set(0)
        cp_xc_button = Checkbutton(title_section_3_2, text="Cp vs Xc", variable=self.cp_xc, relief="groove", width=20, anchor=W, borderwidth=2)
        ...
        self.axis_cut_cp_xc_entry = ttk.Entry(title_section_3_2, textvariable=self.axis_cut_cp_xc, state="disabled")
        ...
        self.x_coord_entry = ttk.Entry(title_section_3_2, textvariable=self.x_coord, state="disabled")
        ...
        self.y_coord_entry = ttk.Entry(title_section_3_2, textvariable=self.y_coord, state="disabled")
        ...
        self.z_coord_entry = ttk.Entry(title_section_3_2, textvariable=self.z_coord, state="disabled")
        ...
        residual_convergence_button = Checkbutton(title_section_3_2, text="Residual convergence", variable=self.residual_convergence, relief="groove", width=20, anchor=W, borderwidth=2)
        residual_convergence_button.grid(row=1, column=2, columnspan=2, padx=2, pady=2)

        self.mach_iso = IntVar()
        self.mach_iso.set(0)
        mach_iso_button = Checkbutton(title_section_3_2, text="Mach isosurface", variable=self.mach_iso, relief="groove", width=20, anchor=W, borderwidth=2)
        mach_iso_button.grid(row=2, column=2, columnspan=2, padx=2, pady=2)

        self.mach_contour = IntVar()
        self.mach_contour.set(0)
        mahc_contour_button = Checkbutton(title_section_3_2, text="Mach contour", variable=self.mach_contour, relief="groove", width=20, anchor=W, borderwidth=2)
        mahc_contour_button.grid(row=3, column=2, columnspan=2, padx=2, pady=2)

        self.cp_contour = IntVar()
        self.cp_contour.set(0)
        cp_contour_button = Checkbutton(title_section_3_2, text="Cp contour", variable=self.cp_contour, relief="groove", width=20, anchor=W, borderwidth=2)
        cp_contour_button.grid(row=4, column=2, columnspan=2, padx=2, pady=2)

        self.slice_cp = IntVar()
        self.slice_cp.set(0)
        slice_cp_button = Checkbutton(title_section_3_2, text="Slice Cp", variable=self.slice_cp, command=self.activateAxisOfCut, relief="groove", anchor=W, width=15, borderwidth=2)
        ...
        self.axis_cut__slice_cp_label = ttk.Label(title_section_3_2, text="Axis of cut", relief="groove", state="disabled", borderwidth=2, width=15, anchor=CENTER)
        ...
        self.nb_slices_entry = ttk.Entry(title_section_3_2, textvariable=self.nb_slices, state="disabled")
        ...
        self.first_coord_entry = ttk.Entry(title_section_3_2, textvariable=self.first_coord, state="disabled")
        ...
        self.last_coord_entry = ttk.Entry(title_section_3_2, textvariable=self.last_coord, state="disabled")
