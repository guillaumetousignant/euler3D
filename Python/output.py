...
class Output():
    def __init__(self, master):
        ...
        self.axis_cut_cp_xc_label_.grid(row=6, column=0, padx=2, pady=2)
        ...
        self.axis_cut_cp_xc_entry_.grid(row=6, column=1, padx=2, pady=2, sticky=NSEW)
        ...
        self.x_coord_label_.grid(row=7, column=0, padx=2, pady=2)
        self.x_coord_entry_ = ttk.Entry(title_section_3_2, textvariable=self.x_coord_, state="disabled", justify=CENTER, takefocus=0)
        self.x_coord_entry_.grid(row=7, column=1, padx=2, pady=2, sticky=NSEW)
        ...
        self.y_coord_label_.grid(row=8, column=0, padx=2, pady=2)
        self.y_coord_entry_ = ttk.Entry(title_section_3_2, textvariable=self.y_coord_, state="disabled", justify=CENTER, takefocus=0)
        self.y_coord_entry_.grid(row=8, column=1, padx=2, pady=2, sticky=NSEW)
        ...
        self.z_coord_label_.grid(row=9, column=0, padx=2, pady=2)
        self.z_coord_entry_ = ttk.Entry(title_section_3_2, textvariable=self.z_coord_, state="disabled", justify=CENTER, takefocus=0)
        self.z_coord_entry_.grid(row=9, column=1, padx=2, pady=2, sticky=NSEW)
        ...
        self.axis_cut_slice_cp_label_.grid(row=6, column=2, padx=2, pady=2)
        ...
        self.axis_cut_slice_cp_entry_.grid(row=6, column=3, padx=2, pady=2, sticky=N)
        ...
        self.first_coord_label_.grid(row=8, column=2, padx=2, pady=2)
        ...
        self.first_coord_entry_.grid(row=8, column=3, padx=2, pady=2, sticky=N)
        ...
        self.last_coord_label_.grid(row=9, column=2, padx=2, pady=2)
        ...
        self.last_coord_entry_.grid(row=9, column=3, padx=2, pady=2, sticky=N)
