...
class Input():
    def __init__(self, master):
        ...
        self.cfl_entry = ttk.Entry(title_section_1_2, textvariable=self.cfl)
        ...
        self.gamma_entry = ttk.Entry(title_section_1_2, textvariable=self.gamma)
        ...
        self.mach_entry = ttk.Entry(title_section_1_2, textvariable=self.mach)
        ...
        self.cmac_entry = ttk.Entry(title_section_1_2, textvariable=self.cmac)
        ...
        self.angle_attack_entry = ttk.Entry(title_section_1_2, textvariable=self.angle_attack)
        ...
        self.rk_entry = ttk.Entry(title_section_1_2, textvariable=self.rk)
